...
fun Routing.ebxmlFrikortRoute(sendEbxmlMessageUseCase: SendEbxmlMessageUseCase) {
    ...
    post("/ebxml/send-cpa") {
        try {
            ...
            log.debug("/ebxml/send-frikort request received: $requestBody")
            ...
            log.debug("/ebxml/send-frikort is returning response: $result")

            when (result) {
                is EbxmlResult.Success -> call.respond(HttpStatusCode.OK, "")
