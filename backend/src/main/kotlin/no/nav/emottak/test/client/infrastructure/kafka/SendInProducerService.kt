...
class SendInProducerService(bootstrapServers: String) : AutoCloseable {

    private val log = LoggerFactory.getLogger(SendInProducerService::class.java)
    ...
    fun publish(topic: String, key: String, value: ByteArray, senderAddress: String = "test@emottak-test.nav.no") {
        val record = ProducerRecord<String, ByteArray>(topic, key, value)
